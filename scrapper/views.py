...
def update_data_for_today():
    ...
    setup_stocks_model(stocks_list_for_setup[:50])
    
    STM.update_prices_for_daily(stocks_list_for_setup[:50])
    STM.update_prices_for_per_minute(stocks_list_for_setup[:50])
